...
<div class="reg-w3">
    <div class="w3layouts-main">
        ...
        ?>
        <form role="form" action="{{route('save-registration')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="text" class="ggg" name="admin_name" placeholder="Vui lòng nhập tên hiển thị" required>
            <input type="text" class="ggg" name="admin_email" placeholder="Vui lòng nhập địa chỉ email" required>
            <input type="text" class="ggg" name="admin_phone" placeholder="Vui lòng nhập số điện thoại" required>
            <input type="file" class="ggg" name="admin_image" id="admin_image">
