...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <div class="container">
                <div class="carousel-caption">
                    <h3>@lang('search.carousel_content_1')
                        <span>@lang('search.carousel_content_2')</span>
                    </h3>
                    <p>@lang('search.carousel_content_3')
                        <span>@lang('search.carousel_content_4')</span> @lang('search.carousel_content_5')</p>
                    <a class="button2" href="product.html"> @lang('search.ordernow')</a>
                </div>
            </div>
        </div>
        <div class="item item2">
            <div class="container">
                <div class="carousel-caption">
                    <h3>@lang('search.carousel_content_6')
                        <span>@lang('search.carousel_content_7')</span>
                    </h3>
                    <p>@lang('search.carousel_content_8')
                        <span>@lang('search.carousel_content_9')</span> @lang('search.carousel_content_10')</p>
                    <a class="button2" href="#">@lang('search.ordernow')</a>
                </div>
            </div>
        </div>
        <div class="item item3">
            <div class="container">
                <div class="carousel-caption">
                    <h3>@lang('search.carousel_content_11')
                        <span>@lang('search.carousel_content_12')</span>
                    </h3>
                    <p>@lang('search.carousel_content_13')
                        <span>@lang('search.carousel_content_14')</span>
                    </p>
                    <a class="button2" href="#">@lang('search.ordernow')</a>
                </div>
            </div>
        ...
        <div class="item item4">
            <div class="container">
                <div class="carousel-caption">
                    <h3>@lang('search.carousel_content_15')
                        <span>@lang('search.carousel_content_16')</span>
                    </h3>
                    <p>@lang('search.carousel_content_17')
                        <span>@lang('search.carousel_content_18')</span> @lang('search.carousel_content_19')</p>
                    <a class="button2" href="#">@lang('search.ordernow')</a>
                </div>
            </div>
        </div>
    ...
    <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
        ...
        <span class="sr-only">@lang('search.previous')</span>
    </a>
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
        <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
        <span class="sr-only">@lang('search.next')</span>
    </a>
</div>
<!-- //banner -->
...
<div class="ads-grid">
    <div class="container">
        <!-- tittle heading -->
        <h3 class="tittle-w3l">@lang('search.title')
        ...
        <div class="side-bar col-md-3">
            <div class="search-hotel">
                <h3 class="agileits-sear-head">@lang('search.search')</h3>
                <form action="{{route('search')}}" method="get">
                    <input type="search" placeholder="@lang('search.place_search')" name="key" required="">
                    <input type="submit" value=" ">
                </form>
            </div>
            <!-- price range -->
            <div class="range">
                <h3 class="agileits-sear-head">@lang('search.price_range')</h3>
            ...
            <!-- food preference -->
            <div class="left-side">
                <h3 class="agileits-sear-head">@lang('search.food_love')</h3>
                <ul>
                    <li>
            ...
            <!-- discounts -->
            <div class="left-side">
                <h3 class="agileits-sear-head">@lang('search.discounts')</h3>
                <ul>
                    <li>
                        <input type="checkbox" class="checked">
            ...
            <div class="customer-rev left-side">
                <h3 class="agileits-sear-head">@lang('search.reviews')</h3>
                <ul>
                    <li>
                        <a href="#">
        ...
        <div class="agileinfo-ads-display col-md-9">
            <div class="wrapper">
                <div class="product-sec1">
                    <h3 class="heading-tittle">@lang('search.title')</h3>
                    ...
                    <div class="col-md-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                ...
                                <span class="product-new-top">@lang('search.label_promo_product')</span>
                            </div>
                                ...
                                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                    <form action="#" method="post">
                                        <fieldset>
                                            ...
                                            <input type="hidden" name="item_unit" value="{{$pro->id_unit}}" />
                                ...
                                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                    <form action="#" method="post">
                                        <fieldset>
                                            ...
                                            <input type="hidden" name="item_unit" value="{{$new->id_unit}}" />
