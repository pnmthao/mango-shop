...
<div class="services-breadcrumb">
    <div class="agile_inner_breadcrumb">
        <div class="container">
            <ul class="w3_short">
                <li>
                    <a href="{{route('trang-chu')}}">@lang('pro_by_cate.home')</a>
                    <i>|</i>
                </li>
                <li>@if(Session::get('locale') == 'en') {{$loai_sp->name_en}} @else {{$loai_sp->name}} @endif</li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="side-bar col-md-3">
            <div class="search-hotel">
                <h3 class="agileits-sear-head">@lang('pro_by_cate.search')</h3>
            ...
            <!-- price range -->
            <div class="range">
                <h3 class="agileits-sear-head">@lang('pro_by_cate.price_range')</h3>
            ...
            <!-- food preference -->
            <div class="left-side">
                <h3 class="agileits-sear-head">@lang('pro_by_cate.food_love')</h3>
                <ul>
                    <li>
            ...
            <!-- discounts -->
            <div class="left-side">
                <h3 class="agileits-sear-head">@lang('pro_by_cate.discounts')</h3>
                <ul>
                    <li>
                        <input type="checkbox" class="checked">
            ...
            <div class="customer-rev left-side">
                <h3 class="agileits-sear-head">@lang('pro_by_cate.reviews')</h3>
                <ul>
                    <li>
                        <a href="#">
                    ...
                    <div class="col-xs-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="uploads/product/{{$sp->image}}" alt="" height="150" width="150" onclick="window.location.href='{{route('chitietsanpham',$sp->id)}}'">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{route('chitietsanpham',$sp->id)}}" class="link-product-add-cart">@lang('pro_by_cate.detail')</a>
                                    </div>
                                </div>
                                <span class="product-new-top">@lang('pro_by_cate.label')</span>
                            </div>
...
<div class="featured-section" id="projects">
    <div class="container">
        <!-- tittle heading -->
        <h3 class="tittle-w3l">@lang('pro_by_cate.other_product')
            <span class="heading-style">
                <i></i>
                <i></i>
                <i></i>
