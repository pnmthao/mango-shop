    ...
    <div class="container">
        ...
        <div class="agileinfo-ads-display col-md-9">
            <div class="wrapper">
                    ...
                    <div class="col-md-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="uploads/product/{{$spkm->image}}" alt="" height="150" width="150">
                ...
                <!-- //first section promotion product -->
                ...
                <div class="product-sec1">
                    ...
                    <div class="col-md-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="uploads/product/{{$sp_tc->image}}" alt="" height="150" width="150">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                ...
                <div class="product-sec1">
                    ...
                    <div class="col-md-4 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="uploads/product/{{$sp_t->image}}" alt="" height="150" width="150">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
